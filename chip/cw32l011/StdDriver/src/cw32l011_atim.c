...
void ATIM_IC1Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC1P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC1NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
...
void ATIM_IC2Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC2P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC2NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
...
void ATIM_IC3Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC3P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC3NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
...
void ATIM_IC4Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC4P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC4NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
...
void ATIM_IC5Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC5P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC5NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
...
void ATIM_IC6Init(ATIM_ICInitTypeDef *ATIM_ICInitStruct)
{
    ...
    CW_ATIM->CCER_f.CC6P = ATIM_ICInitStruct->ICPolarity & 0x01;
    CW_ATIM->CCER_f.CC6NP = (ATIM_ICInitStruct->ICPolarity & 0x02) >> 1;
