...
{
	   REGBITS_SET(CW_LVD->CR1, LVD_CR1_IE_Msk);
...
{
    LVD_DisableNvic();
    REGBITS_CLR(CW_LVD->CR1, LVD_CR1_IE_Msk);
...
void LVD_Init(LVD_InitTypeDef* LVD_InitStruct)
{
    ...
    REGBITS_MODIFY( CW_LVD->CR1,  LVD_CR1_FLTTIME_Msk , \
                    ( LVD_InitStruct->LVD_FilterTime));

    REGBITS_MODIFY( CW_LVD->CR0, LVD_CR0_VTH_Msk | LVD_CR0_SOURCE_Msk | LVD_CR0_ACTION_Msk | LVD_CR0_FLTCLK_Msk, \
