...
void SPI_Init(SPI_TypeDef *SPIx, SPI_InitTypeDef *SPI_InitStruct)
{
    ...
    REGBITS_MODIFY(SPIx->CR1, SPI_CR1_MODE_Msk | \
...
{
    CW_SYSCTRL->APBRST1_f.SPI1 = 0;
    CW_SYSCTRL->APBRST1_f.SPI1 = 1;
}
...
void SPI_DataSizeConfig(SPI_TypeDef *SPIx, uint16_t SPI_DataSize)
{
    ...
    REGBITS_MODIFY(SPIx->CR1, SPI_CR1_WIDTH_Msk, SPI_DataSize);
}
