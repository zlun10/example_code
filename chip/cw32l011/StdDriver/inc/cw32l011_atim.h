...
#define ATIM_BUFFER_ENABLE                     (1UL << ATIM_CR1_ARPE_Pos)
...
#define ATIM_UPDATE_EVENT_NORMAL               (1UL << ATIM_CR1_URS_Pos)  // 上溢出/下溢出
#define ATIM_UPDATE_EVENT_EXTENSION            (0UL) // 上溢出/下溢出/软件更新/从模式复位
