...
#ifndef __CW32L011_UART_H
#define __CW32L011_UART_H
...
#define UART_Over_16                        (((uint16_t)0x0000) << UARTx_CR1_OVER_Pos)
#define UART_Over_8                         (((uint16_t)0x0001) << UARTx_CR1_OVER_Pos)
#define UART_Over_4                         (((uint16_t)0x0002) << UARTx_CR1_OVER_Pos)
#define UART_Over_sp                        (((uint16_t)0x0003) << UARTx_CR1_OVER_Pos)
...
#define UART_Source_PCLK                    (((uint16_t)0x0000) << UARTx_CR1_SOURCE_Pos)
#define UART_Source_LSE                     (((uint16_t)0x0002) << UARTx_CR1_SOURCE_Pos)
#define UART_Source_LSI                     (((uint16_t)0x0003) << UARTx_CR1_SOURCE_Pos)
...
#define UART_StartBit_FE                    (((uint16_t)0x0000) << UARTx_CR1_START_Pos)//RXD下降沿
#define UART_StartBit_LL                    (((uint16_t)0x0001) << UARTx_CR1_START_Pos) //RXD低电平
...
#define UART_StopBits_1                     (((uint16_t)0x0000) << UARTx_CR1_STOP_Pos)
#define UART_StopBits_2                     (((uint16_t)0x0001) << UARTx_CR1_STOP_Pos)
#define UART_StopBits_1_5                   (((uint16_t)0x0002) << UARTx_CR1_STOP_Pos)
...
#define UART_Parity_No                      (((uint16_t)0x0000) << UARTx_CR1_PARITY_Pos)
#define UART_Parity_Even                    (((uint16_t)0x0002) << UARTx_CR1_PARITY_Pos)
#define UART_Parity_Odd                     (((uint16_t)0x0003) << UARTx_CR1_PARITY_Pos)
#define UART_Parity_User                    (((uint16_t)0x0001) << UARTx_CR1_PARITY_Pos)
...
#define UART_Mode_Tx                        (((uint16_t)0x0001) << UARTx_CR1_TXEN_Pos)
#define UART_Mode_Rx                        (((uint16_t)0x0001) << UARTx_CR1_RXEN_Pos)
...
#define UART_HardwareFlowControl_None       (((uint16_t)0x0000) << UARTx_CR2_CTSEN_Pos)
#define UART_HardwareFlowControl_RTS        (((uint16_t)0x0001) << UARTx_CR2_RTSEN_Pos)
#define UART_HardwareFlowControl_CTS        (((uint16_t)0x0001) << UARTx_CR2_CTSEN_Pos)
#define UART_HardwareFlowControl_RTS_CTS    (UART_HardwareFlowControl_RTS | UART_HardwareFlowControl_CTS)
...
#define UART_Clock_Disable                  (((uint16_t)0x0000) << UARTx_CR1_SYNC_Pos)
#define UART_Clock_Enable                   (((uint16_t)0x0001) << UARTx_CR1_SYNC_Pos)
...
#define UART_InvPin_Tx                      (((uint16_t)0x0001) << UARTx_CR2_TXINV_Pos)
#define UART_InvPin_Rx                      (((uint16_t)0x0001) << UARTx_CR2_RXINV_Pos)
#define IS_UART_INVERSTION_PIN(INVPIN)      ((((INVPIN) & (~(UARTx_CR2_TXINV_Msk|UARTx_CR2_RXINV_Msk))) == 0x00) && ((INVPIN) != (uint16_t)0x00))
...
#define UART_LINBreakDetectLength_10b      (((uint16_t)0x0000) << UARTx_CR3_BRKL_Pos)
#define UART_LINBreakDetectLength_11b      (((uint16_t)0x0001) << UARTx_CR3_BRKL_Pos)
...
#define UART_TimerMode_Stop                (((uint16_t)0x0000) << UARTx_CR2_TIMCR_Pos)
#define UART_TimerMode_TimeOut             (((uint16_t)0x0002) << UARTx_CR2_TIMCR_Pos)
#define UART_TimerMode_Idle                (((uint16_t)0x0003) << UARTx_CR2_TIMCR_Pos)
#define UART_TimerMode_AutoBaudRate1       (((uint16_t)0x0005) << UARTx_CR2_TIMCR_Pos)
#define UART_TimerMode_AutoBaudRate2       (((uint16_t)0x0006) << UARTx_CR2_TIMCR_Pos)
#define UART_TimerMode_GeneralTimer        (((uint16_t)0x0007) << UARTx_CR2_TIMCR_Pos)
