...
#ifndef __CW32L011_ADC_H
#define __CW32L011_ADC_H
...
typedef struct
{
    ...
    boolean_t                   ADC_BgrEn;    /* ADC内置基准电压源 */
    
    boolean_t                   ADC_TempSensorEn;    /* ADC内置温度传感器 */
...
/** @defgroup ADC_InputCHx                                
  ...
  * 通道8输入PB01                         * 通道8输入PB00                        
  * 通道9输入PB02                         * 通道9输入PB01                        
  * 通道10输入PB03                        * 通道10输入PA08                         
  * 通道11输入PB04                        * 通道11输入PA09                         
  * 通道12输入PB05                        * 通道12输入PA10                         
  * 通道13输入PB06                        * 通道13输入PA11                         
  * BGR_TS                                * BGR_TS                       
  * Vref1P2                               * Vref1P2                       
  */ 
