...
#ifndef __CW32L011_LVD_H
#define __CW32L011_LVD_H
...
/** @defgroup LVD_interrupts_definition
  * @{
  */
#define LVD_TRIG_LEVEL                  bv1
#define LVD_TRIG_FALL                   bv3
#define LVD_TRIG_RISE                   bv2
...
#define LVD_Threshold_2p2V  ((uint32_t)0x00000010)
#define LVD_Threshold_2p6V  ((uint32_t)0x00000020)
#define LVD_Threshold_3p0V  ((uint32_t)0x00000030)
#define LVD_Threshold_3p4V  ((uint32_t)0x00000040)
#define LVD_Threshold_3p8V  ((uint32_t)0x00000050)
#define LVD_Threshold_4p2V  ((uint32_t)0x00000060)
#define LVD_Threshold_4p6V  ((uint32_t)0x00000070)
...
#define IS_LVD_THRESHOLD(THRESHOLD)  (((THRESHOLD) == LVD_Threshold_1p8V) || \
          ...
          ((THRESHOLD) == LVD_Threshold_3p4V) || \
          ((THRESHOLD) == LVD_Threshold_3p8V) || \
          ((THRESHOLD) == LVD_Threshold_4p2V) || \
          ((THRESHOLD) == LVD_Threshold_4p6V))
...
/** @defgroup LVD_FilterClk
  * @{
  */
#define LVD_FilterClk_LSI      ((uint32_t)0x00000000)
#define LVD_FilterClk_SYSCLK   ((uint32_t)0x00000100)

#define IS_LVD_FILTER_CLK(FILTER_CLK) (((FILTER_CLK) == LVD_FilterClk_LSI) || \
                                       ((FILTER_CLK) == LVD_FilterClk_SYSCLK))
...
#define LVD_FilterTime_2N6     ((uint32_t)0x00000040)
#define LVD_FilterTime_2N8     ((uint32_t)0x00000050)
#define LVD_FilterTime_4N6     ((uint32_t)0x00000060)
#define LVD_FilterTime_4N8     ((uint32_t)0x00000070)
#define LVD_FilterTime_8N6     ((uint32_t)0x00000080)
#define LVD_FilterTime_8N8     ((uint32_t)0x00000090)
#define LVD_FilterTime_16N5    ((uint32_t)0x000000A0)
#define LVD_FilterTime_16N6    ((uint32_t)0x000000B0)
#define LVD_FilterTime_16N8    ((uint32_t)0x000000C0)
#define LVD_FilterTime_32N5    ((uint32_t)0x000000D0)
