...
#ifndef __CW32L011_SYSCTRL_H
#define __CW32L011_SYSCTRL_H
...
#include "system_cw32l011.h"
    ...
    {
        // AHB
        SysctrlPeriphFLASH = SYSCTRL_AHBEN_FLASH_Msk,
        SysctrlPeriphCRC = SYSCTRL_AHBEN_CRC_Msk,
        SysctrlPeriphGPIOA = SYSCTRL_AHBEN_GPIOA_Msk,
        SysctrlPeriphGPIOB = SYSCTRL_AHBEN_GPIOB_Msk,
        SysctrlPeriphGPIOC = SYSCTRL_AHBEN_GPIOC_Msk,
        // APB1
        SysctrlPeriphADC = SYSCTRL_APBEN1_ADC_Msk << 8,
        SysctrlPeriphVC = SYSCTRL_APBEN1_VC_Msk << 8,
        SysctrlPeriphSPI1 = SYSCTRL_APBEN1_SPI1_Msk << 8,
        SysctrlPeriphUART1 = SYSCTRL_APBEN1_UART1_Msk << 8,
        SysctrlPeriphUART2 = SYSCTRL_APBEN1_UART2_Msk << 8,
        SysctrlPeriphATIM = SYSCTRL_APBEN1_ATIM_Msk << 8,
        SysctrlPeriphGTIM1 = SYSCTRL_APBEN1_GTIM1_Msk << 8,
        SysctrlPeriphGTIM2 = SYSCTRL_APBEN1_GTIM2_Msk << 8,
        SysctrlPeriphUART3 = SYSCTRL_APBEN1_UART3_Msk << 8,
        // APB2
        SysctrlPeriphRTC = SYSCTRL_APBEN2_RTC_Msk << 16,
        SysctrlPeriphBTIM123 = SYSCTRL_APBEN2_BTIM123_Msk << 16,
        SysctrlPeriphIWDT = SYSCTRL_APBEN2_IWDT_Msk << 16,
        SysctrlPeriphI2C = SYSCTRL_APBEN2_I2C_Msk << 16,
        SysctrlPeriphLPTIM = SYSCTRL_APBEN2_LPTIM_Msk << 16
    } SYSCTRL_PeriphEnumTypeDef;

    typedef enum
    {
        RESETFLAG_POR = (1 << 0),        // 上电复位 / 掉电复位标志
        RESETFLAG_LVD = (1 << 3),        // LVD 复位标志
        RESETFLAG_IWDT = (1 << 4),       // IWDT 复位标志
        RESETFLAG_RSTB = (1 << 6),       // NRST 引脚复位标志
        RESETFLAG_LOCKUP = (1 << 8),     // LOCKUP 故障复位标志
        RESETFLAG_SYSRESETREQ = (1 << 9) // 内核 SYSRESETREQ 复位标志
    } SYSCTRL_ResetFlagTypeDef;
//==================================================================================
#if !defined(HSE_VALUE)
#define HSE_VALUE ((uint32_t)16000000) /*!< Value of the External oscillator in Hz */
#endif

#if !defined(HSIOSC_VALUE)
#define HSIOSC_VALUE ((uint32_t)96000000) /*!< Value of the Internal High Speed oscillator in Hz. \
                                            The real value may vary depending on the variations   \
                                            in voltage and temperature.  */
#endif

#if !defined(LSI_VALUE)
#define LSI_VALUE ((uint32_t)32800) /*!< Value of the Internal Low Speed oscillator in Hz    \
                                         The real value may vary depending on the variations \
                                         in voltage and temperature.  */
#endif
...
/* SYSCTRL CR1 --------------------------------------------------------*/
#define SYSCTRL_HSIEN SYSCTRL_CR1_HSIEN_Msk
#define SYSCTRL_HSEEN SYSCTRL_CR1_HSEEN_Msk
#define SYSCTRL_LSIEN SYSCTRL_CR1_LSIEN_Msk
#define SYSCTRL_LSEEN SYSCTRL_CR1_LSEEN_Msk
#define SYSCTRL_LSELOCKEN SYSCTRL_CR1_LSELOCK_Msk
...
#define SYSCTRL_LSECCSEN SYSCTRL_CR1_LSECCS_Msk
#define SYSCTRL_HSECCSEN SYSCTRL_CR1_HSECCS_Msk
#define SYSCTRL_CLKCCSEN SYSCTRL_CR1_CLKCCS_Msk
#define IS_SYSCTRL_CCS_STATUS(INSTANCE) (((INSTANCE) == SYSCTRL_LSECCSEN) || \
                                         ((INSTANCE) == SYSCTRL_HSECCSEN) || \
                                         ((INSTANCE) == SYSCTRL_CLKCCSEN))

/* SYSCTRL CR2 --------------------------------------------------------*/
#define SYSCTRL_RAMBRKEN SYSCTRL_CR2_RAMBRKEN_Msk
#define SYSCTRL_LVDBRKEN SYSCTRL_CR2_LVDBRKEN_Msk
#define SYSCTRL_DSBRKEN SYSCTRL_CR2_DSBRKEN_Msk
#define SYSCTRL_LOCKUPBRKEN SYSCTRL_CR2_LOCKUP_Msk
#define SYSCTRL_LSEBRKEN SYSCTRL_CR2_LSEBRKEN_Msk
#define SYSCTRL_HSEBRKEN SYSCTRL_CR2_HSEBRKEN_Msk
#define SYSCTRL_RTC_LOWPOWEREN SYSCTRL_CR2_RTCLPM_Msk
...
#define IS_SYSCTRL_FLASHWAIT_VALUE(VAL) (((VAL) == SYSCTRL_FLASHWAIT_24M) || \
                                         ...
                                         ((VAL) == SYSCTRL_FLASHWAIT_96))

#define __SYSCTRL_FLASHWAT_1HCLK() (CW_SYSCTRL->CR2 = (CW_SYSCTRL->CR2 & (~SYSCTRL_CR2_FLASHWAIT_Msk)) | SYSCTRL_KEY | SYSCTRL_FLASHWAIT_24M)
#define __SYSCTRL_FLASHWAT_2HCLK() (CW_SYSCTRL->CR2 = (CW_SYSCTRL->CR2 & (~SYSCTRL_CR2_FLASHWAIT_Msk)) | SYSCTRL_KEY | SYSCTRL_FLASHWAIT_48M)
#define __SYSCTRL_FLASHWAT_3HCLK() (CW_SYSCTRL->CR2 = (CW_SYSCTRL->CR2 & (~SYSCTRL_CR2_FLASHWAIT_Msk)) | SYSCTRL_KEY | SYSCTRL_FLASHWAIT_72M)
#define __SYSCTRL_FLASHWAT_4HCLK() (CW_SYSCTRL->CR2 = (CW_SYSCTRL->CR2 & (~SYSCTRL_CR2_FLASHWAIT_Msk)) | SYSCTRL_KEY | SYSCTRL_FLASHWAIT_96M)
#define SYSCTRL_WAKEUPCLKEN SYSCTRL_CR2_WAKEUPCLK_Msk
...
#define SYSCTRL_LOCKUPEN SYSCTRL_CR2_LOCKUP_Msk
...
#define SYSCTRL_SWDIODIS SYSCTRL_CR2_SWDIO_Msk
#define IS_SYSCTRL_SWDIO_STATUS(INSTANCE) (((INSTANCE) == SYSCTRL_SWDIOEN) || \
                                           ((INSTANCE) == SYSCTRL_SWDIODIS))

#define SYSCTRL_RSTIOEN 0x00UL
#define SYSCTRL_RSTIODIS SYSCTRL_CR2_RSTIO_Msk

/* SYSCTRL HSI --------------------------------------------------------*/
#if !defined(SYSCTRL_HSI_TRIMCODEADDR)
...
/* SYSCTRL LSI --------------------------------------------------------*/
#if !defined(SYSCTRL_LSI_TRIMCODEADDR)
...
/* SYSCTRL HSE --------------------------------------------------------*/
#define SYSCTRL_HSE_FILTER_OPEN SYSCTRL_HSE_DIGFLT_Msk
...
#define SYSCTRL_HEX_ENPOL_LOW SYSCTRL_HSE_HEXENPOL_Msk

#define SYSCTRL_HSE_MODE_OSC (0x00000000U)
#define SYSCTRL_HSE_MODE_CLK SYSCTRL_HSE_MODE_Msk
...
/* SYSCTRL AHB  --------------------------------------------------------*/
#define SYSCTRL_AHB_PERIPH_GPIOC SYSCTRL_AHBEN_GPIOC_Msk
#define SYSCTRL_AHB_PERIPH_GPIOB SYSCTRL_AHBEN_GPIOB_Msk
#define SYSCTRL_AHB_PERIPH_GPIOA SYSCTRL_AHBEN_GPIOA_Msk
#define SYSCTRL_AHB_PERIPH_CRC SYSCTRL_AHBEN_CRC_Msk
#define SYSCTRL_AHB_PERIPH_FLASH SYSCTRL_AHBEN_FLASH_Msk
#define IS_SYSCTRL_AHB_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFF89) == 0x00) && ((PERIPH) != 0x00))
...
#define __SYSCTRL_GPIOC_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOC_Msk)
#define __SYSCTRL_GPIOB_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOB_Msk)
#define __SYSCTRL_GPIOA_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOA_Msk)
#define __SYSCTRL_CRC_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_CRC_Msk)
#define __SYSCTRL_FLASH_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_FLASH_Msk)

#define __SYSCTRL_GPIOC_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOC_Msk)
#define __SYSCTRL_GPIOB_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOB_Msk)
#define __SYSCTRL_GPIOA_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_GPIOA_Msk)
#define __SYSCTRL_CRC_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_CRC_Msk)
#define __SYSCTRL_FLASH_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->AHBRST, SYSCTRL_AHBRST_FLASH_Msk)

/* SYSCTRL APB1  --------------------------------------------------------*/
#define SYSCTRL_APB1_PERIPH_UART3 SYSCTRL_APBEN1_UART3_Msk
#define SYSCTRL_APB1_PERIPH_GTIM2 SYSCTRL_APBEN1_GTIM2_Msk
#define SYSCTRL_APB1_PERIPH_GTIM1 SYSCTRL_APBEN1_GTIM1_Msk
#define SYSCTRL_APB1_PERIPH_ATIM SYSCTRL_APBEN1_ATIM_Msk
#define SYSCTRL_APB1_PERIPH_UART2 SYSCTRL_APBEN1_UART2_Msk
#define SYSCTRL_APB1_PERIPH_UART1 SYSCTRL_APBEN1_UART1_Msk
#define SYSCTRL_APB1_PERIPH_SPI1 SYSCTRL_APBEN1_SPI1_Msk
#define SYSCTRL_APB1_PERIPH_VC SYSCTRL_APBEN1_VC_Msk
#define SYSCTRL_APB1_PERIPH_ADC SYSCTRL_APBEN1_ADC_Msk
#define IS_SYSCTRL_APB1_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFE00) == 0x00) && ((PERIPH) != 0x00))
...
#define __SYSCTRL_SPI_CLK_ENABLE() REGBITS_SET(CW_SYSCTRL->APBEN1, (SYSCTRL_KEY | SYSCTRL_APB1_PERIPH_SPI1))
...
#define __SYSCTRL_SPI_CLK_DISABLE() (CW_SYSCTRL->APBEN1 = (SYSCTRL_KEY | (CW_SYSCTRL->APBEN1 & (~SYSCTRL_APB1_PERIPH_SPI1))))
...
#define __SYSCTRL_SPI_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->APBRST1, SYSCTRL_APB1_PERIPH_SPI1)
...
#define __SYSCTRL_SPI_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->APBRST1, SYSCTRL_APB1_PERIPH_SPI1)
...
/* SYSCTRL APB2  --------------------------------------------------------*/
#define SYSCTRL_APB2_PERIPH_LPTIM SYSCTRL_APBEN2_LPTIM_Msk
#define SYSCTRL_APB2_PERIPH_I2C SYSCTRL_APBEN2_I2C_Msk
#define SYSCTRL_APB2_PERIPH_IWDT SYSCTRL_APBEN2_IWDT_Msk
#define SYSCTRL_APB2_PERIPH_BTIM123 SYSCTRL_APBEN2_BTIM123_Msk
#define SYSCTRL_APB2_PERIPH_RTC SYSCTRL_APBEN2_RTC_Msk
...
#define __SYSCTRL_I2C_RST_ENABLE() REGBITS_CLR(CW_SYSCTRL->APBRST2, SYSCTRL_APB2_PERIPH_I2C)
...
#define __SYSCTRL_I2C_RST_DISABLE() REGBITS_SET(CW_SYSCTRL->APBRST2, SYSCTRL_APB2_PERIPH_I2C)
...
#define RCC_HSE_FLT_OPEN (0x01000000U)
    ...
    extern void SYSCTRL_PeripheralsClkEnalbe(SYSCTRL_PeriphEnumTypeDef Periph, boolean_t _bool);
    ...
    extern void SYSCTRL_PeripheralsResetEnalbe(SYSCTRL_PeriphEnumTypeDef Periph, boolean_t _bool);
    ...
    extern void SYSCTRL_GotoSleep(void);
    extern void SYSCTRL_GotoDeepSleep(void);
    extern void SYSCTRL_ConfigSleepOnExit(FunctionalState state);

    // 清除复位标志
    extern void SYSCTRL_ClearResetFlags(void);

#ifdef __cplusplus
}
#endif

#endif /* __CW32L011_SYSCTRL_H */
